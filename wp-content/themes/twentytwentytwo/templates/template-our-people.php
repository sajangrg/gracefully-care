    ...
    <div class="row justify-content-center">
      <div class="col-lg-3 py-5">
        <div class="card team team-primary text-center border-0">
          ...
          <div class="content mt-3 px-3">
              <a href="#" class="text-dark h5 mb-0 title">Ariana</a>
      ...
      <div class="col-lg-3 py-5">
        <div class="card team team-primary text-center border-0">
          ...
          <div class="content mt-3 px-3">
              <a href="#" class="text-dark h5 mb-0 title">Claire</a>
      ...
      <div class="col-lg-3 py-5">
        <div class="card team team-primary text-center border-0">
          ...
          <div class="content mt-3 px-3">
              <a href="#" class="text-dark h5 mb-0 title">Dylan</a>
      ...
      <div class="col-lg-3 py-5">
        <div class="card team team-primary text-center border-0">
          ...
          <div class="content mt-3 px-3">
              <a href="#" class="text-dark h5 mb-0 title">Gabriela</a>
              <h6 class="text-muted fw-normal">Support & Care Coordinator</h6>
